{
  ...
  const generateTitleLinks = (customSelector:string = ''):void => {
    ...
    const articles = document.querySelectorAll(selectorArticle + customSelector) as ;
    ...
    const links = document.querySelectorAll('.titles a') as NodeList;
  ...
  const generateTags = ():void => {
    ...
    const articles = document.querySelectorAll(selectorArticle) as NodeList;
    for (let article of articles) {
      ...
      const dataTag:string = article.getAttribute('data-tags');
  ...
  const generateAuthors = ():void => {
    ...
    for (let article of articles) {
      ...
      const author:string = article.getAttribute('data-author');
